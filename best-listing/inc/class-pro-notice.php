...
class wpWax_Theme_Pro_Notice {
	...
	public $notice_dissmiss_id = 'best-listing-dismiss-pro-notice';
	...
	public function admin_notice() {
		if ( isset( $_GET[ $this->notice_dissmiss_id ] ) ) { // @codingStandardsIgnoreLine
			update_user_meta( get_current_user_id(), $this->notice_dissmiss_id, 1 ); // phpcs:ignore WordPress.Security.EscapeOutput
		}
		...
		<div class="notice notice-success is-dismissible directorist-theme-updater-notice directorist-theme-updater-notice-pro">
			<h2>Thank you for using Best Listing Theme. Upgrade to the pro version to unleash all the features!</h2>
			...
			<div class="directorist-updater-action">
				<a class="directorist-btn directorist-btn-updgrade" href="https://directorist.com/product/best-listing-pro/" target="_blank"><?php esc_html_e( 'Upgrade To Pro', 'best-listing' ); ?></a>

				<a class="directorist-btn directorist-btn-bordered" href="<?php echo esc_url( add_query_arg( $this->notice_dissmiss_id, 1 ) ); ?>" class="directorist-btn directorist-btn-updgrade"><?php esc_html_e( 'Dismiss This Notice Permanently', 'best-listing' ); ?></a>
			</div>
		</div>
		<?php
	}
