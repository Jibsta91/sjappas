...
$listing_imgs = ThemeSupport::get_single_listing_images_by_size( get_the_ID(), 'wpwaxtheme-476x340' );
?>
	...
	<div class="theme-single-listing-slider-wrap<?php echo esc_attr( ( $total_photos > 2 ) ? '' : ' has-background-color' ); ?>">
		...
		<div id="theme-single-listing-slider" class="theme-single-listing-slider theme-swiper theme-carousel" data-sw-items="4" data-sw-margin="6" data-sw-loop="true" data-sw-perslide="1" data-sw-speed="1000" data-sw-autoplay="{}" data-sw-responsive='{
			...
			<div class="theme-swiper-navigation">
				...
				<div class="theme-swiper-button-nav theme-swiper-button-prev">
					<?php directorist_icon( 'fa fa-angle-left' ); ?>
				</div>

				<div class="theme-swiper-button-nav theme-swiper-button-next">
					<?php directorist_icon( 'fa fa-angle-right' ); ?>
				</div>
		...
		<?php if ( $total_photos >= 4 ) : ?>
			...
			<div class="theme-single-listing-see-all">
				...
				<?php printf( '<a href="" class="btn theme-btn btn-listing-see-all">%s%s %s</a>', directorist_icon( 'las la-image', false ), esc_html__( 'See photos', 'best-listing' ), $total_photos ); // phpcs:ignore WordPress.Security.EscapeOutput ?>
