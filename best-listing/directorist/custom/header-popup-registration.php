...
<div class="theme-modal-content">    
	<div class="add_listing_title atbd_success_mesage">
		...
		if ( ! empty( $_GET['registration_status'] ) && true == $_GET['registration_status'] ) {
			if ( empty( $display_password ) ) {
				...
				<p style="padding: 20px" class="alert-success">
					...
					_e( ' Go to your inbox or spam/junk and get your password.', 'best-listing' );

					printf( __( ' Click %s to login.', 'best-listing' ), "<a href='" . ATBDP_Permalink::get_login_page_link() . "'><span style='color: red'> " . __( 'Here', 'best-listing' ) . '</span></a>' );
				...
				<p style="padding: 20px" class="alert-success">
					<?php directorist_icon( 'fas fa-check' ); ?>
					<?php _e( 'Registration completed. Please check your email for confirmation.', 'best-listing' ); ?>
					<?php
					printf( __( 'Or click %s to login.', 'best-listing' ), "<a href='#' data-bs-toggle='modal' data-bs-target='#theme-register-modal'><span style='color: red'> " . __( 'Here', 'best-listing' ) . '</span></a>' );
		...
		switch ( $errors ) {
			case '1':
				?>
				 <p style="padding: 20px" class="alert-danger"> <?php directorist_icon( 'fas fa-exclamation-triangle' ); ?> <?php _e( 'Registration failed. Please make sure you filed up all the necessary fields marked with <span style="color: red">*</span>', 'best-listing' ); ?></p>
				<?php
				break;
			case '2':
				?>
				 <p style="padding: 20px" class="alert-danger"> <?php directorist_icon( 'fas fa-exclamation-triangle' ); ?> <?php _e( 'Sorry, that email already exists!', 'best-listing' ); ?></p>
				<?php
				break;
			case '3':
				?>
				 <p style="padding: 20px" class="alert-danger"> <?php directorist_icon( 'fas fa-exclamation-triangle' ); ?> <?php _e( 'Username too short. At least 4 characters is required', 'best-listing' ); ?></p>
				<?php
				break;
			case '4':
				?>
				 <p style="padding: 20px" class="alert-danger"> <?php directorist_icon( 'fas fa-exclamation-triangle' ); ?> <?php _e( 'Sorry, that username already exists!', 'best-listing' ); ?></p>
				<?php
				break;
			case '5':
				?>
				 <p style="padding: 20px" class="alert-danger"> <?php directorist_icon( 'fas fa-exclamation-triangle' ); ?> <?php _e( 'Password length must be greater than 5', 'best-listing' ); ?></p>
				<?php
				break;
			case '6':
				?>
				 <p style="padding: 20px" class="alert-danger"> <?php directorist_icon( 'fas fa-exclamation-triangle' ); ?> <?php _e( 'Email is not valid', 'best-listing' ); ?></p>
				<?php
				break;
			case '7':
				?>
				 <p style="padding: 20px" class="alert-danger"> <?php directorist_icon( 'fas fa-exclamation-triangle' ); ?> <?php _e( 'Space is not allowed in username', 'best-listing' ); ?></p>
				<?php
				break;
			case '8':
				?>
				 <p style="padding: 20px" class="alert-danger"> <?php directorist_icon( 'fas fa-exclamation-triangle' ); ?> <?php _e( 'Please make sure you filed up the user type', 'best-listing' ); ?></p>
				<?php
				break;
		}
		?>
	...
	<form action="<?php echo esc_url( get_the_permalink() ); ?>" method="post">
		<div class="theme-modal-wrap">
			...
			<div class="directorist-form-group directorist-mb-15">
				...
				<label for="r_username"><?php printf( __( '%s', 'best-listing' ), $username ); ?><strong class="directorist-form-required">*</strong></label>
			...
			<div class="directorist-form-group directorist-mb-15">
				...
				<label for="email"><?php printf( __( '%s', 'best-listing' ), $email ); ?> <strong class="directorist-form-required">*</strong></label>
			...
			<?php if ( ! empty( $display_password_reg ) ) : ?>
				...
				<div class="directorist-form-group directorist-mb-15">
					<label for="r_password">
						...
						<?php
						printf( __( '%s ', 'best-listing' ), $password );
			...
			<?php if ( ! empty( $display_fname ) ) : ?>
				...
				<div class="directorist-form-group directorist-mb-15">
					...
					<label for="r_fname">
						...
						printf( __( '%s ', 'best-listing' ), $first_name );
			...
			<?php if ( ! empty( $display_lname ) ) : ?>
				...
				<div class="directorist-form-group directorist-mb-15">
					<label for="r_lname">
						...
						printf( __( '%s ', 'best-listing' ), $last_name );
			...
			<?php if ( ! empty( $display_website ) ) : ?>
				...
				<div class="directorist-form-group directorist-mb-15">
					<label for="website">
						...
						printf( __( '%s ', 'best-listing' ), $website ); 
			...
			<?php if ( ! empty( get_directorist_option( 'display_user_type' ) ) ) : ?>
				...
				<?php if ( empty( $user_type ) || 'author' == $user_type ) : ?>
					...
					<div class="atbd_user_type_area directory_regi_btn directorist-radio directorist-radio-circle directorist-mb-15">
							...
							<label for="author_type" class="directorist-radio__label"><?php _e( 'I am an author', 'best-listing' ); ?>
					</div>
				...
				<?php if ( empty( $user_type ) || 'general' == $user_type ) : ?>
					...
					<div class="atbd_user_type_area directory_regi_btn directorist-radio directorist-radio-circle directorist-mb-15">
						...
						<label for="general_type" class="directorist-radio__label"><?php _e( 'I am a user', 'best-listing' ); ?>
					</div>
			...
			*/
			...
			<?php if ( ! $display_password_reg ) : ?>
				...
				<div class="directory_regi_btn">
					...
					<p><?php _e( 'Password will be e-mailed to you.', 'best-listing' ); ?></p>
			...
			<div class="theme-register-btn">
				...
				<button type="submit" class="directorist-btn directorist-btn-primary" name="atbdp_user_submit"><?php printf( __( '%s ', 'best-listing' ), $reg_signup ); ?></button>
