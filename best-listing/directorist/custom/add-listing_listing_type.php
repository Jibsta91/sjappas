...
$order_id = ! empty( $_GET['order'] ) ? $_GET['order'] : ''; // @codingStandardsIgnoreLine
...
<div class="directorist-form-listing-type">
	...
	<h4 class="directorist-option-title"><?php echo esc_html( $args['onelisting_choose_listing_type_label'] ); ?></h4>
		...
		if ( is_array( $remaining ) && isset( $remaining['regular'] ) ) {
			...
			<?php if ( 'Unlimited' === $regular ) : ?>
				...
				<div class="directorist-form-listing-type__single directorist-radio directorist-radio-circle">
					...
					<label for="regular" class="directorist-radio__label"><?php echo esc_html( $args['onelisting_general_label'] ); ?>

						<span class="atbdp_make_str_green"><?php esc_html_e( ' (Unlimited)', 'best-listing' ); ?></span>
				...
				<div class="directorist-form-listing-type__single directorist-radio directorist-radio-circle">
					...
					<label for="regular" class="directorist-radio__label"><?php echo esc_html( $args['onelisting_general_label'] ); ?>
						...
						<span class="<?php echo $regular > 0 ? 'atbdp_make_str_green' : 'atbdp_make_str_red'; ?>">
							...
							<?php printf( '%1$s of %2$s %3$s', esc_html( $regular ), esc_html( $num_regular ), esc_html__( 'Listing available', 'best-listing' ) ); ?>
			...
			<?php if ( 'Unlimited' === $featured ) : ?>
				...
				<div class="directorist-form-listing-type__single directorist-radio directorist-radio-circle">
					...
					<label for="featured" class="directorist-radio__label featured_listing_type_select">
						...
						<?php echo esc_html( $args['onelisting_featured_label'] ); ?>
				...
				<div class="directorist-form-listing-type__single directorist-radio directorist-radio-circle">
					...
					<label for="featured" class="directorist-radio__label featured_listing_type_select">
						...
						<span class="<?php echo $featured > 0 ? 'atbdp_make_str_green' : 'atbdp_make_str_red'; ?>">
							...
							<?php printf( esc_html__( '%1$s of %2$s Listing available' ), esc_html( $featured ), esc_html( $num_featured ) ); ?>
