...
<div class="directorist-add-listing-types directorist-w-100">
	...
	<div class="directorist-row">
		...
		<div class="cdirectorist-col-12">
			...
			<h1 class="directorist-add-listing-title"><?php echo isset( Theme::$options['choose_listing_type_text'] ) ? esc_html( Theme::$options['choose_listing_type_text'] ) : esc_html__( 'Choose listing type', 'best-listing' ); ?></h1>
