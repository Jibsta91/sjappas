...
use BestListing\wpWax\Helper as WpWaxHelper;
...
$show_similar    = get_directorist_type_option( $listing->type, 'show_similar_listings', true );
$label           = get_directorist_type_option( $listing->type, 'similar_listings_label', esc_html__( 'Similar Properties', 'best-listing' ) );
...
<?php else : ?>
	...
	<div class="directorist-single-contents-area directorist-w-100">
		...
		<?php WpWaxHelper::get_template_part( 'directorist/custom/single-header-slider', $listing ); ?>
