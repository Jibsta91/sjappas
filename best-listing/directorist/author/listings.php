...
<div class="directorist-author-listing-top directorist-flex directorist-justify-content-between directorist-align-center">
	...
	<h2 class="directorist-author-listing-top__title"><?php esc_html_e( 'Author Listings', 'best-listing' ); ?></h2>
	...
	<?php if ( $author->cat_filter_enabled() ) : ?>
		...
		<div class="directorist-dropdown directorist-dropdown-js directorist-author-listing-top__dropdown directorist-dropdown-update-js">
			...
			<a class="directorist-dropdown__toggle directorist-dropdown__toggle-js directorist-toggle-has-icon directorist-btn directorist-btn-outline-primary" href="#" id="directorist-dropdown-menu-link"><?php esc_html_e( 'Filter by category', 'best-listing' ); ?> <span class="atbd_drop-caret"></span></a>

			<div class="directorist-dropdown__links directorist-dropdown__links-js">

				<?php
				foreach ( $author->get_listing_categories() as $category ) {
					$active_class = ( isset( $_GET['category'] ) && ( $category->slug == $_GET['category'] ) ) ? esc_html('active') : ''; // @codingStandardsIgnoreLine
					$link         = directorist_add_query_args_with_no_pagination( array( 'category' => $category->slug ) ); // phpcs:ignore WordPress.Security.EscapeOutput
...
<div class="directorist-author-listing-content">
	...
	<div class="<?php Helper::directorist_row(); ?>">
		...
		<?php foreach ( $listings->post_ids() as $listing_id ) : ?>
			...
			<div class="<?php Helper::directorist_column( array( 'lg-4', 'md-4' ) ); ?>">
