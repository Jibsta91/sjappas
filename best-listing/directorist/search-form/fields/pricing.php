...
$label           = isset( $data['label'] ) ? $data['label'] : __( 'Price', 'best-listing' );
?>

<?php if ( ThemeSupport::has_field_in_search_form( 'pricing', $searchform, 'advance' ) ) : ?>
	...
	<div class="directorist-search-field directorist-price-ranges-wrapper">
		...
		<div class="theme-search-dropdown">
			...
			<div class="theme-search-dropdown__label">
				<label><?php echo esc_html( ! empty( $data['label'] ) ? $data['label'] : __( 'Price', 'best-listing' ) ); ?></label>
			</div>
