...
$date_format = apply_filters( 'best_listing_related_post_date_format', 'F j, Y' );
...
<div class="theme-related-post-area m-top-60">
	...
	<div class="related-post-title text-center">
		...
		<h3>
			<?php echo isset( Theme::$options['related_post_title'] ) ? esc_html( Theme::$options['related_post_title'] ) : ''; ?>
		</h3>
									...
									<ul class="list-unstyled">
										...
										<?php if ( Theme::$options['average_reading_time'] && has_category() ) : ?>
											...
											<li class="theme-blog-reading-time-meta">
												<?php echo Helper::get_reading_time( get_the_content(), 'span' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>
											</li>
